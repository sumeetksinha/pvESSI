#ifndef __pvESSI_GaussMesh_h
#define __pvESSI_GaussMesh_h
...
class pvESSI_GaussMesh : public vtkUnstructuredGridAlgorithm{

public:
  vtkTypeMacro(pvESSI_GaussMesh,vtkUnstructuredGridAlgorithm);
  void PrintSelf(ostream& os, vtkIndent indent);

  void PrintX(int x){}
 
  static pvESSI_GaussMesh *New();
...
private:
  ...
  pvESSI_GaussMesh(const pvESSI_GaussMesh&);  // Not implemented.
  void operator=(const pvESSI_GaussMesh&);  // Not implemented.
